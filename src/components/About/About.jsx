                ...
                <div className='about__content'>
                    <div className='about-background color-background-accent'>
                        ...
                        <div className='text-container'>
                            <p>
                                Hey there! 👋 I'm a junior frontend developer originally from Japan, based in Seattle. I thrive on bringing the technical and visual aspects of digital products to life.  Right now, my main focus is on front-end web development, but I'm eager to explore more about the backend side of things in the future. </p>
